<?php
  ...
  else
  {
    ...
    $sql = "SELECT * FROM artigos WHERE area_artigo ='psicologia'";
  }
...
<head>
    ...
    <title>Artigos sobre psicologia</title>
</head>
<body>
  ...
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
    ...
    <div class="container-fluid p-5 bg-success text-white text-center">
        <h1>ARTIGOS SOBRE PSICOLOGIA</h1> 
      </div>
  <br>
  <br>
    ...
    <script>
      ...
      function searchData()
      {
        window.location = 'artigopsico.php?search=' +search.value;
      }
    </script>
